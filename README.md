...
**אלגוריתם אבולוציוני להמלצת סרטים**
...
נחבר את הערכים שהתקבלו מכל איטרציה והערך הסופי מייצג את ה-fitness. נרצה לקבל ציון הכי גבוה עבור ה-fitness לכן הגדרנו higher is better = true.
